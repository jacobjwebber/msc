...
The first results gathered were execution times for each loop for every available loop schedule.

\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{"graphs/loop1_blocksize"}
\caption{Graph showing execution time for loop 1 against block size for the guided, dynamic and static schedules. The error bars show 1 standard deviation. Note that these error bars are much larger than in loop 2, indicating greater performance variability. }
\label{image-myimage}
\end{figure}
