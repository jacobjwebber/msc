...
One likely problem to emerge from this implementation is that the whole work assignment function is executed is a critical region. This means that only one thread may be in the section at a time. This could have negative consequences for horizontal scalability. Threads could be idling waiting to be assigned work because another is in this critical region, particularly when there is a large amount of threads in total.
...
\subsection{Speed Up of Schedules}
